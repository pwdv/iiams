    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'System Admin'), ('MANAGER', 'Manager'), ('WAREHOUSE', 'Warehouse Staff'), ('PROCUREMENT', 'Procurement'), ('TECHNICIAN', 'Technician'), ('AUDITOR', 'Auditor')], default='WAREHOUSE', max_length=20)),
